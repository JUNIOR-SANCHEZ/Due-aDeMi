...
class pgfController extends tutorasController
{
    ...
    public function lista_pgf_ajax()
    {
        if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
            ...
            $paginador = new Paginador();
            $this->_view->assign('l', $paginador->paginar($this->_sql->listapgf(), $pagina));
            $this->_view->assign('paginador', $paginador->getView('paginacion_ajax'));
    ...
    public function pdf($id)
    {
        ...
        <table border="1" cellspacing="" cellpadding="5" >
            <tr>
                <td colspan="2"><strong> Proyecto Global De Familia</strong></td>
            </tr>
            <tr>
                <td>Familia:</td>
                <td><?=$dato->familia?></td>
        ...
        <table border="1" cellspacing="" cellpadding="5" >
           <tr>
            ...
            <tr>
                <td colspan="2"><p><strong>Descripcion</strong></p><?=$item["acti_descripcion"]?></td>
            </tr>
            <tr>
                <td><p><strong>Responsables</strong></p><?=$item["acti_responsable"]?></td>
               <td>
                    <p><strong>Tiempo</strong></p><?=$item["acti_tiempo"]?></td>
            </tr>
            <tr>
                <td><p><strong>Evaluacion</strong></p><?=$item["acti_evaluacion"]?></td>
               <td><p><strong>Observaciones</strong></p><?=$item["acti_observacion"]?></td>
            </tr>
        </table>
        <p></p>
        <table border="1" cellspacing="" cellpadding="5" >
            ...
            <tr>
                <td><?=$item["descripcion_area_acomp"]?></td>
           </tr>
        </table>
        <?php endforeach;?>
        <?php
