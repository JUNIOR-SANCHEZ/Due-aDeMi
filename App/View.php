...
class View extends Smarty {
    ...
    public function renderizar($vista, $item = false, $noLayout = false) {
        ...
        $params = array(
            'bootstrap_css' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/bower_components/bootstrap/dist/css/bootstrap.min.css',
            'fontAwesome_css' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/bower_components/font-awesome/css/font-awesome.min.css',
            'ionicons_css' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/bower_components/Ionicons/css/ionicons.min.css',
            'jquery_jvectormap_css' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/bower_components/jvectormap/jquery-jvectormap.css',
            ...
            'jquery_ui_js' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/bower_components/jquery-ui/jquery-ui.min.js',
            'bootstrap_js' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/bower_components/bootstrap/dist/js/bootstrap.min.js',
            'raphaelp_js' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/bower_components/raphael/raphael.min.js',
            'morris_js' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/bower_components/morris.js/morris.min.js',
            'jquery_sparkline_js' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js',
            'jvectormap_js' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js',
            'jvectormap_world_js' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/plugins/jvectormap/jquery-jvectormap-world-mill-en.js',
            'jquery_knob_js' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/bower_components/jquery-knob/dist/jquery.knob.min.js',
            'moment_js' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/bower_components/moment/min/moment.min.js',
            'bootstrap_daterangepicker_js' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/bower_components/bootstrap-daterangepicker/daterangepicker.js',
            'bootstrap_datepicker_js' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js',
            'bootstrap_wysihtml5_js' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js',
            'jquery_slimscroll_js' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/bower_components/jquery-slimscroll/jquery.slimscroll.min.js',
            'fastclick_js' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/bower_components/fastclick/lib/fastclick.js',
            'AdminLTE_js' => BASE_URL . 'views/layout/' . DEFAULT_LAYOUT . '/dist/js/adminlte.min.js',
