...
class ninasModel extends Model
{
    ...
    public function nuevaNina($fecha_ingreso,$nombre, $apellido,$lugar_nacimiento,$fecha_naciminto,$foto,$cedula,$telef,$direcion,$tipo_medida,$num_medida,$fecha_medida,$org_oper)
    {
        $this->table('ninas');
